...
public class SubsystemsStatus extends ACSClient {
	...
	/**
	 * This is the constructor to SubsystemsStatus
	 * 
	...
	/**
	 * This method return a list of status on json format related to the Subsystems
	 * 
	 * @return A linked list of subsystems status on json format
	 */
	@Override
